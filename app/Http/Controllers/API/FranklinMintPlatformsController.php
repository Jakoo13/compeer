...
use App\Models\FranklinMintPlatforms;
use App\Models\User;
use Illuminate\Support\Facades\Auth;

class FranklinMintPlatformsController extends Controller
{
    ...
    {
        return FranklinMintPlatforms::find($id);
    }
	...
	public function store(Request $request, $id)
    {
        ...
        return FranklinMintPlatforms::create([
            'id' => $user->id,
    ...
    {
        $platform = FranklinMintPlatforms::findOrFail($id);
