...
use App\Models\FarmersCartPlatforms;
use App\Models\User;
use Illuminate\Support\Facades\Auth;

class FarmersCartPlatformsController extends Controller
{
    ...
    {
        return FarmersCartPlatforms::find($id);
    }
	...
	public function store(Request $request, $id)
    {
        ...
        return FarmersCartPlatforms::create([
            'id' => $user->id,
    ...
    {
        $platform = FarmersCartPlatforms::findOrFail($id);
