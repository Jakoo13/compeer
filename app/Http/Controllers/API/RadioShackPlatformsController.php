...
use App\Models\RadioShackPlatforms;
use App\Models\User;
use Illuminate\Support\Facades\Auth;

class RadioShackPlatformsController extends Controller
{
    ...
    {
        return RadioShackPlatforms::find($id);
    }
	...
	public function store(Request $request, $id)
    {
        ...
        return RadioShackPlatforms::create([
            'id' => $user->id,
    ...
    {
        $platform = RadioShackPlatforms::findOrFail($id);
