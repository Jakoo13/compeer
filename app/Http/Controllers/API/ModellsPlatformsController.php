...
use App\Models\ModellsPlatforms;
use App\Models\User;
use Illuminate\Support\Facades\Auth;

class ModellsPlatformsController extends Controller
{
    ...
    {
        return ModellsPlatforms::find($id);
    }
	...
	public function store(Request $request, $id)
    {
        ...
        return ModellsPlatforms::create([
            'id' => $user->id,
    ...
    {
        $platform = ModellsPlatforms::findOrFail($id);
