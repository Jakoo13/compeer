...
use App\Models\Pier1Platforms;
use App\Models\User;
use Illuminate\Support\Facades\Auth;

class Pier1PlatformsController extends Controller
{
    ...
    {
        $platform = Pier1Platforms::findOrFail($id);
