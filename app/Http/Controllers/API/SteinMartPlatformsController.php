...
use App\Models\SteinMartPlatforms;
use App\Models\User;
use Illuminate\Support\Facades\Auth;

class SteinMartPlatformsController extends Controller
{
    ...
    {
        return SteinMartPlatforms::find($id);
    }
	...
	public function store(Request $request, $id)
    {
        ...
        return SteinMartPlatforms::create([
            'id' => $user->id,
    ...
    {
        $platform = SteinMartPlatforms::findOrFail($id);
