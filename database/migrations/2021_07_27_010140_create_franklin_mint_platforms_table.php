...
class CreateFranklinMintPlatformsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('franklin_mint_platforms', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('franklin_mint_platforms');
    }
}
