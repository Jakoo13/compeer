...
class CreateLinensNThingsPlatformsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('linens_n_things_platforms', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('linens_n_things_platforms');
    }
}
